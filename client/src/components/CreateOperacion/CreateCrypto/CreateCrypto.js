...
const CreateCrypto = ({operacionData, setOperacionData, divisaRecibe}) => {
    ...
    return ( <div>
            ...
            <div className="data-cont">
                ...
                <div className="radio-container">
                    <input type="radio" value="Compra" checked={operacionData.operacion_crypto === "Compra"} onClick={(e)=>setOperacionData({...operacionData, operacion_crypto: e.target.value})} />
                    <label htmlFor="Compra">Compra</label>
                    <input type="radio" value="Venta" checked={operacionData.operacion_crypto === "Venta"} onClick={(e)=>setOperacionData({...operacionData, operacion_crypto: e.target.value})} />
                    <label htmlFor="Venta">Venta</label>
                </div>
            </div>

            {operacionData.operacion_crypto &&
            <>

...
const CreateSubida = ({operacionData, setOperacionData, divisaRecibe}) => {
        ...
        <div>
            ...
            <div className="data-cont">
                ...
                <div className="radio-container">
                    <input type="radio" value="Cliente" checked={operacionData.tipo_envia === "Cliente"} onClick={(e)=>setOperacionData({...operacionData, tipo_envia: e.target.value, proveedor: null, cuenta_destino: null, comision_proveedor: 0, comision_proveedor: 0})} disabled />
                    <label htmlFor="Cliente">Cliente</label>
                    <input type="radio" value="Proveedor" checked={operacionData.tipo_envia === "Proveedor"} onClick={(e)=>setOperacionData({...operacionData, tipo_envia: e.target.value, cliente_recibe: null})} />
            ...
            <div className="data-cont">
                <label>Monto a Subir</label>
                <span style={{"fontSize" : "0.7em", "color":"#94a2b1"}}>{divisaRecibe}</span>

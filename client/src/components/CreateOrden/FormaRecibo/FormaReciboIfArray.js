...
const FormaRecibo = ({opciones, setBorrarForma, entregaID, entregas, setEntregas, setMontosCheck, montosCheck, cliente, setHayOrden, editedOrd = false, NoEditable=false }) => {

    const [nota, setNota] = useState('vacioOculto')
    
    useEffect(()=>{
        
        setEntregas({...entregas, recibo : true})

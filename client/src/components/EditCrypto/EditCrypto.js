...
const EditCrypto = ({data, setRenderModal}) => {
    ...
    useEffect(()=>{
        setOperacionData({...operacionData, monto_llega: operacionData.monto_enviado, monto_a_entregar: operacionData.monto_enviado})
    }, [operacionData.monto_enviado])
    ...
    return ( 
        ...
        <FormHeader edit={edit} setEdit={setEdit} tipo="Crypto" />
        ...
        <div>
            ...
            <div className="multiple-data-cont">
                ...
                <div className="data-cont">
                    <Input type="text" value={operacionData.cliente.nombre} disabled  disabled={!edit}/>
                </div>
                :
                <>
            ...
            <div className="data-cont">
                <label>Operación Crypto</label>
                <div className="radio-container">
                    <input type="radio" value="Venta" checked={operacionData.operacion_crypto === "Venta"} onClick={(e)=>setOperacionData({...operacionData, operacion_crypto: e.target.value})}  disabled={!edit}/>
                    <label htmlFor="Venta">Venta</label>
                    <input type="radio" value="Compra" checked={operacionData.operacion_crypto === "Compra"} onClick={(e)=>setOperacionData({...operacionData, operacion_crypto: e.target.value})}  disabled={!edit}/>
                    <label htmlFor="Compra">Compra</label>
                </div>
            </div>

            <div className="multiple-data-cont">
                {operacionData.operacion_crypto === "Venta" &&
                <div className="data-cont">
                ...
                <div className="data-cont" style={{width: "100%"}} >
                    ...
                    <select onChange={(e)=>setOperacionData({...operacionData, proveedor: e.target.value})} value={operacionData?.proveedor?._id} disabled={!edit}>
                        ...
                        {proveedores.map((proveedor)=>
                            <option value={proveedor?._id} selected={proveedor?._id === operacionData?.proveedor?._id} key={proveedor._id}>{proveedor.nombre} - ({proveedor.divisa})</option>
                            )}
                    </select>
                </div>
                <div className="data-cont" style={{width: "100%"}} >
            ...
            {operacionData.operacion_crypto === "Compra" &&
            <div className="multiple-data-cont">
            ...
            <FormEditBtns handleSubmit={handleSubmit} setRenderModal={setRenderModal} edit={edit} tipo="Crypto" />
